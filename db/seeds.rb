...
Spell.create([
  ...
  # {spell_name: "Avada Kedavra", spell_impact: "Causes instantaneous death. It is accompanied by a flash of green light and a rushing noise.", point_value: 5, wizard_id: 17},
  # {spell_name: "Magicus Extremos", spell_impact: "Partnership-based charm that temporarily increases the casters' spell power.", point_value: 5, wizard_id: 18},
